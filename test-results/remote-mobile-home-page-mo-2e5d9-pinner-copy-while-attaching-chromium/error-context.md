...
- Name: remote-mobile.spec.ts >> home page (mobile) >> shows the starting-room spinner copy while attaching
- Location: e2e/remote-mobile.spec.ts:16:7
...
Locator: getByText(/Đang mở phòng/i)
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/Đang mở phòng/i)
